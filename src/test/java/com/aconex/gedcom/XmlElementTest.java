...
public class XmlElementTest {
    ...
    public void shouldReturnXmlElementWithAttribute() {
        ...
        assertThat(xmlElement.getMarkup(0), is("<div height=\"21\">content</div>"));
    }
    ...
    public void shouldFetchXmlMarkUpFromChildNodes() {
        ...
        assertThat(xmlElement.getMarkup(0), is("<video>\n\t<length>60</length>\n</video>"));
    }
    ...
    public void shouldFetchXmlMarkupFromMultipleChildNodesProperly() {
        ...
        xmlElement.addChild(childXmlElement1);
        xmlElement.addChild(childXmlElement2);
    ...
    public void shouldSetContentOfXmlElementAsValueWhenChildNodesArePresent() {
        ...
        assertThat(xmlElement.getMarkup(0), is("<video value=\"future_of_programming.mp4\">\n\t<length>60</length>\n</video>"));
    }
    ...
    public void shouldProperlyIndentGeneratedXmlMarkupWithChildElements() {
        ...
        xmlElement.addChild(lengthXmlElement);
        lengthXmlElement.addChild(unitsXmlElement);

        assertThat(xmlElement.getMarkup(0), is("<video value=\"tesla_auto.mp4\">\n\t<length value=\"60\">\n\t\t<units>minutes</units>\n\t</length>\n</video>"));
    }
    ...
    public void shouldIncludeElementsAttributeAsWellAsItsContentAsValueAttributeWhenItHasChildren() {
        ...
        assertThat(xmlElement.getMarkup(0), is("<video value=\"future_of_programming.mp4\" id=\"2dba-2asf\">\n\t<length>60</length>\n</video>"));
    }
}
